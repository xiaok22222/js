...
async function all() {
    ...
    while (true) {      
        ...
        //console.log(time); 
        if(time == "12:00:00" || time == "20:00:00") {
            await withdrawal1();
...
function withdrawal1() {
    return new Promise((resolve, reject) => {
        const url = "http://api.gaoqingdianshi.com/api/v2/cash/withdrawal?code=tx00025&rs=weM1opsXPEik&sign=ef11e7077bfa42ddacb340a28ccfd3be";
        const headers = {
